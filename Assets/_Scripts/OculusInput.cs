...
public class OculusInput : MonoBehaviour
{
    ...
    private void CommonInput()
    {
        ...
        // A Button
        if (controller.inputDevice.TryGetFeatureValue(CommonUsages.primaryButton, out primary))
            output += "A Pressed: " + primary + "\n";

        // B Button
        if (controller.inputDevice.TryGetFeatureValue(CommonUsages.secondaryButton, out secondary))
        ...
        if (controller.inputDevice.TryGetFeatureValue(CommonUsages.primary2DAxisClick, out press))
